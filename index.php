...
<html lang="nl">
	<head>
		<title>Project Extra Opdracht</title>
		<meta charset="utf-8">
	...
	<body>
		...
		<form method="post" action="index.php">
			...
			<span class="zijde">Zijde A:</span><input type="text" name="zijdeA" class="pixels" placeholder="Pixels">&nbsp;pixels<br><br>

			<span class="zijde">Zijde B:</span><input type="text" name="zijdeB" class="pixels" placeholder="Pixels">&nbsp;pixels<br><br>
